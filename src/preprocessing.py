...
if __name__  == '__main__':
    ...
    dataset = pd.read_json(cfg.KISTI_FILE_PATH, lines=False)
    # dataset = pd.read_json('/data/kisti/demo/demo_tagging_train_result.json', lines=False)
    ...
    section_dataset = pickle.load(open(cfg.DATA_SAVE_PATH+'section_final.pkl', 'rb'))
    ...
    section_dataset = section_dataset.fillna('')
    
    isection_dataset = pickle.load(open(cfg.DATA_SAVE_PATH+'data_sidx_cleaned.pkl', 'rb'))
    ...
    isection_dataset = isection_dataset.fillna('')
    ...
    if args.plm == 'korscibert':
        ...
        pickle.dump(train_dataloader, open(cfg.DATA_SAVE_PATH+'korscibert_train_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(dev_dataloader, open(cfg.DATA_SAVE_PATH+'korscibert_dev_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(test_dataloader, open(cfg.DATA_SAVE_PATH+'korscibert_test_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        ...
        print("Save DataLoader...")
        pickle.dump(train_dataloader, open('demo_train_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(dev_dataloader, open('demo_dev_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(test_dataloader, open('demo_test_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        
        
         
        """ RAW SECTION DATALOADER """
        ...
        print("Save DataLoader...")
        pickle.dump(strain_dataloader, open(cfg.DATA_SAVE_PATH+'korscibert_osection_train_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(sdev_dataloader, open(cfg.DATA_SAVE_PATH+'korscibert_osection_dev_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(stest_dataloader, open(cfg.DATA_SAVE_PATH+'korscibert_osection_test_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        
        
        
        """ REAL VALUE INDEX SECTION DATALOADER """
        ...
        print("Save DataLoader...")
        pickle.dump(istrain_dataloader, open(cfg.DATA_SAVE_PATH+'korscibert_isection_train_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(isdev_dataloader, open(cfg.DATA_SAVE_PATH+'korscibert_isection_dev_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(istest_dataloader, open(cfg.DATA_SAVE_PATH+'korscibert_isection_test_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        ...
        print("Save DataLoader...")
        pickle.dump(train_dataloader, open(cfg.DATA_SAVE_PATH+'train_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(dev_dataloader, open(cfg.DATA_SAVE_PATH+'dev_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(test_dataloader, open(cfg.DATA_SAVE_PATH+'test_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        ...
        print("Save DataLoader...")
        pickle.dump(strain_dataloader, open(cfg.DATA_SAVE_PATH+'section_train_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(sdev_dataloader, open(cfg.DATA_SAVE_PATH+'section_dev_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(stest_dataloader, open(cfg.DATA_SAVE_PATH+'section_test_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        
        
        
        """ REAL VALUE SECTION DATALOADER """
        ...
        print("Save DataLoader...")
        pickle.dump(istrain_dataloader, open(cfg.DATA_SAVE_PATH+'isection_train_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(isdev_dataloader, open(cfg.DATA_SAVE_PATH+'isection_dev_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
        pickle.dump(istest_dataloader, open(cfg.DATA_SAVE_PATH+'isection_test_dataloader.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
