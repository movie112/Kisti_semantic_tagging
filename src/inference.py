...
if __name__ == '__main__':
    ...
    parser.add_argument('--logger_file', type=str, default='./results/inference.log')
    parser.add_argument('--logger', type=str, default='inference')
    parser.add_argument('--plm', type=str, default='korscibert')
    parser.add_argument('--model_name', type=str, default=cfg.MODEL_SAVE_PATH+'korscibert_raw.bin')
    parser.add_argument('--loader_name', type=str, default=cfg.DATA_SAVE_PATH+'korscibert_osection_test_dataloader.pkl')
